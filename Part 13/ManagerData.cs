...
public class ManagerData
{
    ...
    public ManagerData(string managerName, string managerDescription, int rarity, BigDouble quantity, BigDouble quantityToLevel, BigDouble price, Sprite icon, ManagerTypes managerType, Generator target)
    {
